...
if __name__ == "__main__":
    ...
    config = '/home/pengjian/Cas_Former_24var_440/config_finetune.yaml'
...
# from models.afno_attention_parallel import AFNOAttnParallelNet
# import torch.distributed as dist
# from model_train_test import ModelTrain
# import sys
# import os
# import logging
# import yaml
...
#         attn_channel_ratio=0.20
#     )
#     config = '/home/pengjian/CAS_Former/config_finetune.yaml'
#     with open(config, 'r') as f:
#         config = yaml.safe_load(f)
#     Train = ModelTrain(model,config,local_rank)
#     Train.train(2)